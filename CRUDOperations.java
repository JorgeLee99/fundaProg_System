...
public class CRUDOperations {
    ...
    public static String processResidentRegistration(Object[] data){
        ...
        try {
            ...
            String query2 = "UPDATE households SET total_residents = total_residents + 1 WHERE household_id = ?";
    ...
    public static String getAllResidents(){
        ...
        public static String updateResident(String choice, Object newValue, int ID){
            ...
            try{
                ...
                String query = "UPDATE residents SET " + choice + " = ? WHERE resident_id = ?";
                PreparedStatement ps = conn.prepareStatement(query);
        ...
        public static String deleteResident(int id){
            ...
            try{
                ...
                String query0 = "SELECT household_id FROM residents WHERE resident_id = ?";
